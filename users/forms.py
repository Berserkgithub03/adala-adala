...
JUDGMENT_CHOICES = [
    ...
    ('القسم المدني', 'القسم المدني'),
    ('قسم الجنح', 'قسم الجنح'),
    ('قسم المخالفات', 'قسم المخالفات'),
    ('القسم الاستعجالي', 'القسم الاستعجالي'),
    ('قسم شؤون الأسرة', 'قسم شؤون الأسرة'),
    ('قسم الأحداث', 'قسم الأحداث'),
    ('القسم الاجتماعي', 'القسم الاجتماعي'),
    ('القسم العقاري', 'القسم العقاري'),
    ('القسم البحري', 'القسم البحري'),
    ('القسم التجاري', 'القسم التجاري'),
